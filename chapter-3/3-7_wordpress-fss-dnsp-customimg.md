...
Agora, irei criar dois _[registros](https://en.wikipedia.org/wiki/List_of_DNS_record_types)_. Um do tipo _A_ e outro _CNAME_, que será um _"apelido"_ para o registro do tipo _A_. Ficará mais ou menos assim:
