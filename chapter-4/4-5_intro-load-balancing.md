...
- **Público ou Privado**
    - Um balanceador de carga _público_ é criado em uma subrede pública com endereço IP público, e acessível pela internet. Este endereço público tem a característica de ser _"flutuante"_. Ou seja, ele se alternará para o balanceador de carga secundário (standby) em caso de falha no principal.
