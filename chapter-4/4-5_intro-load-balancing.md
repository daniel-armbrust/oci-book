...
- **Público ou Privado**
    - Um balanceador de carga _**público**_ é criado em uma subrede pública com endereço IP público, e acessível pela internet. 
    - Já um balancedor de carga _**privado**_ é criado em uma subrede privada com o intuito de não receber requisições pela internet, e fazer _"frente"_ somente com recursos internos.
