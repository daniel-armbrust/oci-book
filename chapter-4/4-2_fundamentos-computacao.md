...
- **Marketplace**
    ...
    - Podem haver situações em que utilizar uma imagem do _[marketplace](https://cloudmarketplace.oracle.com/marketplace/oci)_, pode ser necessário adquirir licenciamento diretamente com o fabricante da imagem. Há outros casos em que o OCI já faz esta cobrança adicional de forma automática. Esteja atento a estes detalhes!