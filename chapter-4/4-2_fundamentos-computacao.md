...
Por último, o parâmetro _"--ssh-authorized-keys-file"_ que especifica o caminho das _chaves SSH públicas_. As _chaves públicas_, existentes no arquivo _./wordpress-key.pub_, são adicionadas ao arquivo _/home/opc/.ssh/authorized_keys_ da instância no momento da sua criação. Isto irá permitir a autenticação por _[chave SSH](https://docs.oracle.com/pt-br/iaas/Content/Compute/Tasks/managingkeypairs.htm)_, já dito anteriormente.
