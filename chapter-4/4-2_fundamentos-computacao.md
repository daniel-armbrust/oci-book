...
- **Marketplace**
    ...
    - Podem haver situações em que utilizar uma imagem do _[marketplace](https://cloudmarketplace.oracle.com/marketplace/oci)_, pode ser necessário adquirir licenciamento diretamente com o fabricante da imagem. Há outros casos em que o OCI já faz cobrança adicional automaticamente. Esteja atento a estes detalhes!