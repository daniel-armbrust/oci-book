...
É possível confirmar a conectividade pela propriedade _"peering-status"_ com valor _"PEERED"_. Também é possível ver o anúncio do bloco _[CIDR](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing)_ vindo da _[VCN](https://docs.oracle.com/pt-br/iaas/Content/Network/Tasks/managingVCNs_topic-Overview_of_VCNs_and_Subnets.htm)_ de banco de dados (vcn-db) através da propriedade _"peer-advertised-cidr"_ e que contém o valor _"172.16.0.0/16"_.
